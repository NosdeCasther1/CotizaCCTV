            ...
            try {
                ...
                switch (name) {
                    ...
                    case "describe_table": {
                        ...
                        const [rows] = await pool.query("SELECT COLUMN_NAME, COLUMN_TYPE, IS_NULLABLE, COLUMN_KEY, COLUMN_DEFAULT, EXTRA FROM information_schema.columns WHERE table_schema = ? AND table_name = ? ORDER BY ORDINAL_POSITION", [DB_DATABASE, table_name]);
                        return {
                            content: [
                                {
                                    type: "text",
